...
- Tokens y recovery keys de Vault: guardar en Secrets Manager, nunca en git
- Certificados TLS generados localmente: proteger claves privadas

## Reporte de vulnerabilidades

Si encontrás un problema de seguridad, abrí un [GitHub Security Advisory](https://github.com/ghcetraro/terraform_aws_eks_vault/security/advisories/new) o contactá al mantenedor del repo. No abras issues públicos con detalles explotables.
